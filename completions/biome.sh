...
# @option --max-diagnostics <none|<NUMBER>>    Cap the amount of diagnostics displayed.
...
# @option --reporter[json|json-pretty|github|junit|summary|gitlab]  Allows to change how diagnostics and summary are reported.
...
# @flag --formatter                            Prints the formatter options applied
# @flag --linter                               Prints the linter options applied
# @flag -h --help                              Prints help information
rage() {
    :;
}
...
# {{ biome start
# @cmd Starts the Biome daemon server process.
# @option --log-prefix-name <STRING>    Allows to change the prefix applied to the file name of the logs.
# @option --log-path <PATH>             Allows to change the folder where logs are stored.
...
# {{ biome stop
# @cmd Stops the Biome daemon server process.
# @flag -h --help    Prints help information
stop() {
    :;
}
...
# @option --use-editorconfig <true|false>          Use any `.editorconfig` files to configure the formatter.
...
# @option --javascript-assists-enabled <true|false>  Control the linter for JavaScript (and its super languages) files.
...
# @option --json-assists-enabled <true|false>      Control the linter for JSON (and its super languages) files.
...
# @option --css-linter-enabled <true|false>        Control the linter for CSS files.
# @option --css-assists-enabled <true|false>       Control the assists for CSS files.qq
# @option --graphql-formatter-enabled <true|false>  Control the formatter for GraphQL files.
# @option --graphql-formatter-indent-style <tab|space>  The indent style applied to GraphQL files.
# @option --graphql-formatter-indent-width <NUMBER>  The size of the indentation applied to GraphQL files.
# @option --graphql-formatter-line-ending[lf|crlf|cr]  The type of line ending applied to GraphQL files.
# @option --graphql-formatter-line-width <NUMBER>  What's the max width of a line applied to GraphQL files.
# @option --graphql-formatter-quote-style <double|single>  The type of quotes used in GraphQL code.
# @option --graphql-linter-enabled <true|false>    Control the formatter for GraphQL files.
# @option --assists-enabled <true|false>           Whether Biome should enable assists via LSP.
# @option --colors <off|force>                     Set the formatting mode for markup: "off" prints everything as plain text, "force" forces the formatting of markup using ANSI even if the console output is determined to be incompatible
# @flag --use-server                               Connect to a running instance of the Biome daemon server.
# @flag --verbose                                  Print additional diagnostics, and some diagnostics show more information.
# @option --config-path <PATH>                     Set the file path to the configuration file, or the directory path to find `biome.json` or `biome.jsonc`.
...
# @option --organize-imports-enabled <<true|false>]> <--assists-enabled=<true|false>> <--changed> <--since=REF>
# @option --vcs-enabled <true|false>               Whether Biome should integrate itself with the VCS client
# @option --vcs-client-kind <git>                  The kind of client.
# @option --vcs-use-ignore-file <true|false>       Whether Biome should use the VCS ignore file.
# @option --vcs-root <PATH>                        The folder where Biome should check for VCS files.
...
# @option --css-formatter-quote-style <double|single>  The type of quotes used in CSS code.
# @option --css-linter-enabled <true|false>        Control the linter for CSS files.
# @option --css-assssists-enabled <true|false>       Control the assists for CSS files.
# @option --graphql-formatter-enabled <true|false>  Control the formatter for GraphQL files.
# @option --graphql-formatter-indent-style <tab|space>  The indent style applied to GraphQL files.
# @option --graphql-formatter-indent-width <NUMBER>  The size of the indentation applied to GraphQL files.
# @option --graphql-formatter-line-ending[lf|crlf|cr]  The type of line ending applied to GraphQL files.
...
# @option --linter-enabled <true|false>            Allow to enable or disable the linter check.
# @option --organize-imports-enabled <true|false>  Allow to enable or disable the organize imports.
# @option --assists-enabled <true|false>           Allow to enable or disable the assists.
# @flag --changed                                  When set to true, only the files that have been changed compared to your `defaultBranch` configuration will be linted.
# @option --since <REF>                            Use this to specify the base branch to compare against when you're using the --changed flag and the `defaultBranch` is not set in your biome.json
# @flag -h --help                                  Prints help information
ci() {
...
# {{ biome migrate
# @cmd Updates the configuration when there are breaking changes.
# @option --colors <off|force>                 Set the formatting mode for markup: "off" prints everything as plain text, "force" forces the formatting of markup using ANSI even if the console output is determined to be incompatible
# @flag --use-server                           Connect to a running instance of the Biome daemon server.
# @flag --verbose                              Print additional diagnostics, and some diagnostics show more information.
# @option --config-path <PATH>                 Set the file path to the configuration file, or the directory path to find `biome.json` or `biome.jsonc`.
...
# {{ biome search
# @cmd EXPERIMENTAL: Searches for Grit patterns across a project.
# @option --colors <off|force>                   Set the formatting mode for markup: "off" prints everything as plain text, "force" forces the formatting of markup using ANSI even if the console output is determined to be incompatible
# @flag --use-server                             Connect to a running instance of the Biome daemon server.
# @flag --verbose                                Print additional diagnostics, and some diagnostics show more information.
# @option --config-path <PATH>                   Set the file path to the configuration file, or the directory path to find `biome.json` or `biome.jsonc`.
...
# @option --vcs-root <PATH>                      The folder where Biome should check for VCS files.
# @option --vcs-default-branch <BRANCH>          The main branch of the project
# @option --stdin-file-path <PATH>               Use this option when you want to search through code piped from `stdin`, and print the output to `stdout`.
# @flag -h --help                                Prints help information
# @arg pattern
# @arg path*
search() {
...
# {{ biome explain
# @cmd Shows documentation of various aspects of the CLI.
# @flag -h --help    Prints help information
# @arg name
explain() {
    :;
...
# {{ biome clean
# @cmd Cleans the logs emitted by the daemon.
# @flag -h --help    Prints help information
clean() {
    :;
}
